package br.com.suporteti.sedevendas;
...
public class SedevendasApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(SedevendasApplication.class, args);
	}
