...
public class DbService {
	...
	public void instantiatetestdatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Elias Calado", "eliasteocalado@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
	//	cli1.addPerfil(Perfil.CLIENTE); se nao informado já é perfil de cliente.
		
		Cliente cli2 = new Cliente(null, "Ana Cristina", "aninhaccalado@hotmail.com", "88183052479", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli2.getTelefones().addAll(Arrays.asList("30363323", "97138393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220833", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Caxanga", "211", "Sala 2", "Torre", "50611-050", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Abdias de Carvalho", "129", "Apto 777", "Cordeiro", "50613-070", cli2, c2);
		...
		Pedido ped3 = new Pedido(null, sdf.parse("10/10/2018 19:35"), cli2, e3);
