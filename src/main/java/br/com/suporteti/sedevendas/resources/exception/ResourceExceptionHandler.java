...
import br.com.suporteti.sedevendas.services.exceptions.FileException;
import br.com.suporteti.sedevendas.services.exceptions.ObjectNaoFoundException;

@ControllerAdvice
public class ResourceExceptionHandler {
	// objectNaoFoundException troquei por objectNaoFound
	@ExceptionHandler(ObjectNaoFoundException.class)
	public ResponseEntity<StandardError> objectNaoFound(ObjectNaoFoundException e, HttpServletRequest request) {
